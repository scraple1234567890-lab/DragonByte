...
function renderArticles(articles, query = "") {
  ...
  articles.forEach((row) => {
    ...
    title.textContent = row.title || "Untitled";
	    ...
	    if (hasTags) {
	      // Ensure author info doesn't get clipped in the fixed-height (collapsed) cards.
	      // We do this by reserving a bit more space for the caption area on *this* card.
	      toggle.style.setProperty("--articleCaptionHeight", "160px");
