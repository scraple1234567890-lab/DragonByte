...
function renderArticles(articles, query = "") {
  ...
  articles.forEach((row) => {
    ...
    const handleToggle = () => {
      ...
      if (open && articlesContainer) {
        const openedCards = articlesContainer.querySelectorAll(".articleCard.isOpen");
        openedCards.forEach((otherCard) => {
          ...
          const fallbackBody = otherCard.querySelector(".articleBody");
