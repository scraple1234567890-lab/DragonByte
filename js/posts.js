...
function setImageLayout(img, size, align) {
...
function wireArticleRichEditor() {
  ...
  articleEditor.addEventListener("click", (event) => {
    ...
    if (img instanceof HTMLImageElement && img.classList.contains("rt-img")) {
      ...
      const size = getImageSizeFromClass(img);
  ...
  const updateSelectedImage = () => {
    ...
    setImageLayout(selectedEditorImage, size, align);
  };

  if (articleImageSizeSelect instanceof HTMLSelectElement) {
    articleImageSizeSelect.addEventListener("change", updateSelectedImage);
  }
  if (articleImageAlignSelect instanceof HTMLSelectElement) {
    articleImageAlignSelect.addEventListener("change", updateSelectedImage);
  }
